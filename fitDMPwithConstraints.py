...
demo_folder = "demos/splines2D-2020-01-09-15-01-34"
...
for d in range(1, 9):
    ...
    plt.scatter(val_starts[:3, 0].detach().cpu(),
                val_starts[:3, 1].detach().cpu(),
                c='r', marker='x')
    plt.scatter(val_starts[-1, 0].detach().cpu(),
                val_starts[-1, 1].detach().cpu(),
                c='r', marker='x')
    plt.scatter(val_starts[3, 0].detach().cpu(),
                val_starts[3, 1].detach().cpu(),
                c='black', marker='x')
